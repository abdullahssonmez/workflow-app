...
1.  **FileZilla'yı açın** ve sunucunuza bağlanın (`IP: SUNUCU_IP_ADRESINIZ`, Kullanıcı: `root`).
...
## Tebrikler! 🎉
Artık tarayıcınızdan `http://SUNUCU_IP_ADRESINIZ` adresine giderek uygulamanızı görebilirsiniz.
